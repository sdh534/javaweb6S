...
<script>
	...
	window.onload = function(){
			//글자수 제한
		const textarea = document.getElementById("answer_context");
	...
	function answerQnA(qna_idx){
		...
		$.ajax({
			...
			data : {
				answer_context :  $("#answer_context").val(),
				qna_idx : qna_idx
			},
			success : function(res) {
				Swal.fire({
																...
																<div class="row p-2">
																	<div class="custom-input mr-3">
																		<select class="btn border" name="searchCategory">
																			<option value="m_mid"
																				<c:if test="${fn:indexOf(searchVO.searchCategory, 'm_mid')!=-1}">selected</c:if>>아이디</option>
																			<option value="p_name"
													...
													<div class="row">
														<div class="col-12 p-3">
															<textarea class="textbox w-100" name="answer_context"
																id="answer_context" style="height: 100px;">${fn:replace(QnA.answer_context, "<br/>", "&#10;")}</textarea>
