...
<head>
<meta charset="utf-8">
<title>PARADICE | 관리자 상품 등록</title>
<meta content="width=device-width, initial-scale=1.0" name="viewport">
<meta content="" name="keywords">
<meta content="" name="description">
<script src="${ctp}/ckeditor/ckeditor.js"></script>
<jsp:include page="/WEB-INF/views/include/bs4.jsp" />
<script src="${ctp}/js/admin/productInsert.js"></script>
<script
	    	...
	    	productInsert.p_info.value = p_info_playPersonMin + "/" + p_info_playPersonMax + "/" + p_info_playAge + "/" + p_info_playTime + "/";
				...
				//파일 제외 나머지를 전부 직렬화 -> 객체로 만들어버림 	 			
	 			...
	 			$.ajax({
	 				...
	 				　　　　url: '${ctp}/admin/prodct/addProduct', 
	 				　　　　data: formData, 
								...
								<div class="bg-white rounded-lg h-100 p-4">
									<div class="mb-3">
										...
										<input class="form-control admin-input" type="text"
											name="p_name" id="p_name"> <span style="color: #ccc;">상품
											명은 30글자를 초과할 수 없습니다.</span>
									</div>
									<div class="mb-3">
										<h5>가격</h5>
										...
										<div class="row col-xl-12">
											<div
												...
												<input class="custom-control-input " type="radio"
													name="p_sellStatus" id="p_sellNow0" value="0"> <label
													class="custom-control-label" for="p_sellNow0">노출안함</label>
											</div>
											<div
												class="custom-control custom-radio custom-control-inline ml-3">
												<input class="custom-control-input" type="radio"
													name="p_sellStatus" id="p_sellNow1" value="1"> <label
													class="custom-control-label" for="p_sellNow1">정상판매</label>
											</div>
						...
						<div class="bg-white rounded-lg h-100 p-4">
							...
							<div class="row mb-3 col-xl-12 d-flex flex-column">
								...
								<div style="display: flex; align-items: center;">
									사용 연령 <input class="col-sm-1 col-xl-4 mr-2 ml-2 admin-input"
										type="number" name="p_info_playAge" id="p_info_playAge">세
								</div>
								<div
							...
							<div class="row m-0">
								...
								<input type="hidden" name="p_info"
									id="p_info>
							<hr>
							<input type="button" class="btn btn-round btn-secondary form-control mb-3" value="미리보기">
							<input type="button" class="btn btn-round btn-danger form-control mb-3" value="상품 추가" onclick="addProduct()">
							</div>	
						</div>
					</div>
				<!-- Form End -->
			...
			<div class="bg-light rounded-top p-4">
				<div class="row">
					...
					<div class="col-12 col-sm-6 text-center text-sm-end">
						<!--/*** This template is free as long as you keep the footer authorâs credit link/attribution link/backlink. If you'd like to use the template without the footer authorâs credit link/attribution link/backlink, you can purchase the Credit Removal License from "
									https://htmlcodex.com/credit-removal". Thank you for your
									support.***/--> Designed By <a
